...
public class KhuyenMaiDao {
    ...
    public static List<KhuyenMai> getAllKhuyenMaiHieuLuc(LocalDate ngay ) {
        List<KhuyenMai> dsKhuyenMai = new ArrayList<>();
        try {
            java.sql.Connection con = Connection.getConnection();
            PreparedStatement ps = null;
            // Lấy khuyến mãi nếu ngày hiện tại chưa qua ngayKT
            ps = con.prepareStatement("SELECT * FROM KhuyenMai WHERE ngayKetThuc >= ?");

            // Đặt tham số cho ngày hiện tại
    ...
    public static KhuyenMai tim(String maKM) {
        java.sql.Connection con = Connection.getConnection();
        PreparedStatement ps = null;
        ResultSet rs = null;
        KhuyenMai km = null;
