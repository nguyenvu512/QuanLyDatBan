...
//        checkbox hiện mật khẩu
    ...
    private void initComponents() {
        ...
        label_thongBao.setBackground(new java.awt.Color(255, 255, 255));
        label_thongBao.setFont(new java.awt.Font("JetBrains Mono ExtraLight", 0, 12)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txt_matKhau, javax.swing.GroupLayout.PREFERRED_SIZE, 216, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(130, 130, 130)
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 0, 430, 372));
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 290, 372));
    ...
    private void btn_dangNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_dangNhapActionPerformed
        ...
        char[] a= txt_matKhau.getPassword();
        matKhau = new String(a);
                
        TaiKhoan taiKhoan = TaiKhoan_DAO.timKiem(tenDangNhap);
        if(taiKhoan == null){
            label_thongBao.setText("Tên đăng nhập hoặc mật khẩu không chính xác!");
            return;
        }else{
            Boolean check = BCrypt.checkpw(matKhau, taiKhoan.getMatKhau());
            if(check == true){
                if(taiKhoan.getHoatDong()==false){
                label_thongBao.setText("Tài khoản này đã ngưng hoạt động!");
                    return;
                }else{
                    label_thongBao.setText("");
                    nhanVien=taiKhoan.getNhanVien();
                    this.setVisible(false);
                    new MainGUI(nhanVien);
                }
            }else{
                label_thongBao.setText("Tên đăng nhập hoặc mật khẩu không chính xác!");
                return;
