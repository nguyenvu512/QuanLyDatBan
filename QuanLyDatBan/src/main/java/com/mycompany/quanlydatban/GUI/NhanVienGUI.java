...
public class NhanVienGUI extends javax.swing.JPanel {
    ...
    public NhanVienGUI() {
        ...
        add(jp_MaNV, BorderLayout.SOUTH);
    ...
    private void bt_XoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_XoaActionPerformed
        ...
        if (r != -1) {
            ...
            if (result == JOptionPane.YES_OPTION) {
                ...
                if (nv_d.xoaNV(dtm.getValueAt(r, 0).toString()) && TaiKhoan_DAO.xoaTaiKhoan(dtm.getValueAt(r, 5).toString())) {
                    dtm.setRowCount(0);
                    dataToTable();
                }
            }
...
//            LocalDate ngaySinh = LocalDate.parse(ngays, DateTimeFormatter.ofPattern("dd-MM-yyyy"));
    ...
    private void bt_ThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_ThemActionPerformed
        ...
        TaiKhoan tk = TaiKhoan_DAO.timKiemByTenDangNhap(SDT);
        if(tk != null){
        ...
        try {
            if(nv_d.themNV(nv)){
                dtm.setRowCount(0);
                dataToTable();
                TaiKhoan_DAO.taoTaiKhoan(nv.getSoDienThoai(), BCrypt.hashpw("1111", BCrypt.gensalt()), nv);
                JOptionPane.showMessageDialog(this, "Thêm thành công!\n Tài khoản của nhân viên đã được tạo với Tên đăng nhập là Số điện thoại và mật khẩu mặc định là 1111.\n Vui lòng đăng nhập và đổi mật khẩu");
            }
        } catch (Exception e) {
    ...
    private void jcb_chuVuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcb_chuVuActionPerformed
        // TODO add your handling code here:
        String r = jcb_chuVu.getSelectedItem().toString();
        isNhanVien = r.equals(EnumChucVu.NHAN_VIEN.toString()) ? true : false;
        System.out.println(r + isNhanVien);
...
//        jt_NgaySinh.setText("");
   ...
   public void xuatExcel(List<NhanVien> data) {
    ...
    private final String path = "D:\\PTUD\\QuanLyDatBan\\QuanLyDatBan\\QuanLyDatBan\\excel_monAn";
}
