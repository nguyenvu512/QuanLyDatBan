...
public class MainGUI extends javax.swing.JFrame {
    ...
    public MainGUI() {
        ...
        menuItem_BanAn.setContentAreaFilled(false); // Tắt nền
        menuItem_BanAn.setFocusPainted(false); // Tắt hiệu ứng khi được focus
        menuItem_BanAn.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseEntered(MouseEvent e) {
                menuItem_BanAn.setBackground(Color.BLACK); // Chuyển màu khi hover
            }
            @Override
            public void mouseExited(MouseEvent e) {
                menuItem_BanAn.setBackground(color_bg); // Chuyển màu khi hover
            }
        });
    ...
    private void initComponents() {
        ...
        jp_menu.add(menuItem_TaiKhoan, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 440, 260, 50));
        ...
        jp_menu.add(menuItem_NhanVien, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 390, 260, 50));

        getContentPane().add(jp_menu, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 250, 470));
        ...
        jp_rootLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jp_rootLayout.createSequentialGroup()
                ...
                .addComponent(btn_main_img, javax.swing.GroupLayout.PREFERRED_SIZE, 0, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        ...
        getContentPane().add(jp_root, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 0, 650, 440));
