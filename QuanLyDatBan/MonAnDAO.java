...
public class MonAnDAO {
    ...
    public List<MonAn> getAllMonAn() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                byte[] hinhAnh = rs.getBytes(5);
                DanhMucMonAn danhMuc = new DanhMucMonAn();
                danhMuc.setMaDanhMuc(rs.getString(6));
    ...
    public boolean themMonAn(MonAn f) {
        java.sql.Connection con = Connection.getConnection();
        PreparedStatement ps = null;
        int n = 0;
        try {
            ...
            ps.setDouble(4, f.getGiaTien());
            ps.setString(4, f.getMoTa());
            ps.setBytes(5, f.getHinhAnh());
    ...
    public MonAn timMonAn(String maF){
        java.sql.Connection con = Connection.getConnection();
        PreparedStatement ps = null;
        ResultSet rs=null;
        MonAn f = null;
